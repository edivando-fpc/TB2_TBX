...
begin
  ...
  {$IFDEF FPC}
//  FImageList.Resolutions.Current.Handle := ImageList_LoadBitmap(HInstance, 'TB2SYSMENUIMAGES',  16, 0, clSilver);
  {$ELSE}
...
begin
  ...
  if Application.MainForm = nil then
    Exit;
  Form := TForm(TForm(Application.MainForm.ActiveMDIChild));
  if Form = nil then
    Exit;
